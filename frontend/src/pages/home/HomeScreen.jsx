      ...
      <div className='relative h-screen text-white'>
        ...
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
          ...
          <div className='max-w-2xl'>
            ...
            <p className='mt-4 text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio cumque ipsam obcaecati quibusdam illo voluptate natus placeat enim inventore, iusto commodi nulla, tenetur eligendi omnis illum in maiores non magni.</p>
          </div>
          <div className="flex mt-8">
            ...
            <Link to='/watch/123' className='bg-gray-500/70 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded mr-4 flex items-center'>
            <Info className='size-6 mr-2'/>
            Info
            </Link>
          </div>
